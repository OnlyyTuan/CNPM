// frontend/admin-dashboard/src/components/Layout/Sidebar.jsx
...
const navItems = [
    ...
    { name: 'Tuyển đường', path: '/routes', icon: 'FaMapMarkedAlt' },
    // Có thể thêm Parents List, Users/Admins Management
];
